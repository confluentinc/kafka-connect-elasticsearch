...
2. Clone your fork of the GitHub repository, replacing `<username>` with your GitHub username.
    ...
    ```bash
    git clone git@github.com:<username>/kafka-connect-elasticsearch.git
    ```

    Or https:

    ```bash
    git clone https://github.com/<username>/kafka-connect-elasticsearch.git
    ```
...
8. Submit a pull-request
    ...
    ```bash
    https://github.com/<username>/kafka-connect-elasticsearch.git
    ```
