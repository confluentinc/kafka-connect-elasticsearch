...
public class ElasticsearchValidator extends Validator{

  private static final Logger log = LoggerFactory.getLogger(ElasticsearchValidator.class);
  ...
  public ElasticsearchValidator(Map<String, String> props) {
    this(props, null);
  }

  // Exposed for testing
  protected ElasticsearchValidator(Map<String, String> props, ClientFactory clientFactory) {
    try {
