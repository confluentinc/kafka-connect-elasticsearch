...
public class ElasticsearchSinkConnectorConfig extends AbstractConfig {
  ...
  public static final String USE_AUTO_GENERATED_IDS = "use.autogenerated.ids";
  private static final String USE_AUTO_GENERATED_IDS_DOC =
          "Whether to use auto-generated Elasticsearch document IDs. When this is set to ``true``, ``schema.ignore`` option will be ignored";
  ...
  private static void addConversionConfigs(ConfigDef configDef) {
    ...
    configDef.define(
        ...
        ++order,
        Width.LONG,
        "Use Elasticsearch's auto-generated document IDs");
  }
