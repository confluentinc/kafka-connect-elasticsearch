...
public class ElasticsearchSinkConnectorConfig extends AbstractConfig {
  ...
  private static Map<String, Object> addDefaultReporterConfig(Map<String, Object> originals) {
    originals.putIfAbsent(ReporterConfig.RESULT_KEY_FORMATTER_NAME, "json");
    originals.putIfAbsent(ReporterConfig.RESULT_VALUE_FORMATTER_NAME, "json");
    originals.putIfAbsent(ReporterConfig.ERROR_KEY_FORMATTER_NAME, "json");
    originals.putIfAbsent(ReporterConfig.ERROR_VALUE_FORMATTER_NAME, "json");
