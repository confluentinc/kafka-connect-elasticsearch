...
public class OpensearchValidator extends Validator {

  private static final Logger log = LoggerFactory.getLogger(OpensearchValidator.class);
  ...
  public OpensearchValidator(Map<String, String> props) {
    this(props, null);
  }

  // Exposed for testing
  protected OpensearchValidator(Map<String, String> props, ClientFactory clientFactory) {
    try {
