...
public class ExternalResourceExistenceChecker {
  ...
  public interface ExternalResourceExistenceStrategy {
     ...
     */
    boolean exists(ElasticsearchClient client, String resource)
  ...
  public static class IndexAndDataStreamExistenceStrategy
    ...
    @Override
    public boolean exists(ElasticsearchClient client, String resource)
            throws IOException, ElasticsearchException {
      return client.indices().exists(e -> e.index(resource)).value();
    }
  }
  ...
  public static class AliasExistenceStrategy implements ExternalResourceExistenceStrategy {
    ...
    public boolean exists(ElasticsearchClient client, String resource)
            throws IOException, ElasticsearchException {
      return client.indices().existsAlias(e -> e.name(resource)).value();
    }
  }
