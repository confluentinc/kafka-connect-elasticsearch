...
public class ElasticsearchClient {
   ...
   * path, using the same jittered exponential backoff as {@link RetryUtil} elsewhere in this class.
   *
   ...
   * indexExists/createIndex/createMapping/hasMapping, via {@link #callWithRetries}) is passed
   * through unchanged: those calls already have their own retry loop one layer up via
   ...
   * configured in this class for the same reason).
   *
   ...
   */
  private static final class RetryingTransport implements ElasticsearchTransport {
