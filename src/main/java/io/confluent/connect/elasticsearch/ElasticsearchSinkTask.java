  ...
  public void start(Map<String, String> props, JestClient client) {
    try {
      ...
      if (client != null) {
        ...
        String username = config.getString(ElasticsearchSinkConnectorConfig.CONNECTION_USERNAME_CONFIG);
        String password = config.getString(ElasticsearchSinkConnectorConfig.CONNECTION_PASSWORD_CONFIG);
