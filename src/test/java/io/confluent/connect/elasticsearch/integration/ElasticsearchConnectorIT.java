...
public class ElasticsearchConnectorIT extends ElasticsearchConnectorBaseIT {
  ...
  private final String topic1 = "users-topic";
  private final String topic2 = "orders-topic";
  private final String index1 = "users-index-1";
  private final String index2 = "users-index-2";
  private final String index3 = "orders-index-1";
  private final String index4 = "orders-index-2";
  ...
  private final String dataStream1 = "logs-users-1";
  private final String dataStream2 = "logs-users-2";
  private final String dataStream3 = "logs-orders-1";
  private final String dataStream4 = "logs-orders-2";
  private final String alias1 = "users-alias";
  private final String alias2 = "orders-alias";
